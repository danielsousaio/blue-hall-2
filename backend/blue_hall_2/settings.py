"""
Django settings for blue_hall_2 project.
...
WSGI_APPLICATION = 'blue_hall_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_hall_2 API",
    "DESCRIPTION": "API documentation for blue_hall_2 App",
    "VERSION": "v1",
}
